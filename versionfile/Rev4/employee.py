...
class empClass:
    def __init__(self, root):
        ...
        # options
        cmb_search = ttk.Combobox(SearchFrame, textvariable=self.var_searchby, values=("Select", "eid", "Name", "Email", "Contact"), state='readonly', justify=CENTER, font=("Century Gothic", 12))
        ...
        # title
        title = Label(self.root, text = "Employee Details", font= ("Century Gothic", 15, "bold"), bg="#000080", fg="white").place(x=40, y=80, width=1000)

        #content ROW1
        lbl_empid = Label(self.root, text = "Emp ID", font= ("Century Gothic", 15), bg="white").place(x=40, y=120)
        ...
        txt_empid = Entry(self.root, textvariable=self.var_emp_id, font= ("Century Gothic", 15), bg="lightyellow").place(x=140, y=120, width=200)
        ...
        # contact ROW2
        lbl_name = Label(self.root, text = "Name", font= ("Century Gothic", 15), bg="white").place(x=40, y=160)
        ...
        txt_name = Entry(self.root, textvariable=self.var_name, font= ("Century Gothic", 15), bg="lightyellow").place(x=140, y=160, width=200)
        ...
        # contact ROW3
        lbl_email = Label(self.root, text = "Email", font= ("Century Gothic", 15), bg="white").place(x=40, y=200)
        ...
        # contact ROW4
        lbl_address = Label(self.root, text = "Address", font= ("Century Gothic", 15), bg="white").place(x=40, y=240)
        ...
        self.txt_address.place(x=140, y=240, width=300, height=70)
        ...
        emp_frame.place(x=0, y=325, relwidth=1, height=220)
